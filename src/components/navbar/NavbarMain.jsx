...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1300px] mx-auto w-full px-4 fixed left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2">
      <div className="flex justify-between w-full max-w-[1200px] mx-auto  bg-black items-center pl-6 pr-6 lg:p-4 rounded-3xl shadow-2xl shadow-orange-200">
      ...
      <div className="flex lg:hidden sm:block p-4 bg-black items-center justify-center rounded-3xl  border-orange border-[0.5px] ">
        <NavbarToggler />
      </div>
    </nav>
  );
